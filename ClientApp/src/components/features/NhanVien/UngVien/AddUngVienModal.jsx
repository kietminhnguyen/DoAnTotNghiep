...
export class AddUngVienModal extends Component {
    ...
    constructor(props) {
        ...
        //this.DieuKienKhongDongModal = this.DieuKienKhongDongModal.bind(this)
    }
    SnackbarClose = (event) => {
    ...
    handleSubmit(event) {
        ...
        //console.log(event.target.UngvienSoCMNN.value)
            ...
            if (tinhNgayCapCMND < 14 || ktNgayCapVsNgayHienTai == 1) { // chưa đủ 14 tuổi & ngày cấp sau hiện tại 
                ...
                if (flagSoCMND == true) {
                    ...
                    if ((flagTuoi == true && flagNgayCapCMND == true)
                        ...
                        axios.post('https://localhost:44390/api/ungviens/', {
                            ////id : null,                
                            ...
                            //hinhanh: event.target.UngvienHINH.value.substring(12, 100),
                        ...
                        alert("Thành công ")
                        this.resetForm()
                        //console.log("null: " + this.state.UngvienSDT)
                    } else {

                        alert("VUI LÒNG KIỂM TRA LẠI!!!")
                        //this.resetFormFalse()
                        //console.log("khác null: " + this.state.UngvienSDT)
                    }
                }
            }
        }
                        ...
                        <Row className="mb-3">
                            <Col sm={3}>
                                <label className="btn btn-link btn-sm ml-5">
                                    CHỌN HÌNH<input type="file" hidden name="UngvienHINH"
